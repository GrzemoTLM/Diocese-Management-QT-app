...
# Template: app
# Command: C:\Qt\6.5.1\mingw_64\bin\qmake.exe -o Makefile DioceseManagement.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: DioceseManagement.pro C:/Qt/6.5.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.5.1/mingw_64/mkspecs/features/spec_pre.prf \
