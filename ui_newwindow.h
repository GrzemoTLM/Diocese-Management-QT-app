...
public:
    ...
    void setupUi(QMainWindow *NewWindow)
    {
        ...
        LabelComboBox->setGeometry(QRect(10, 10, 311, 41));
        ...
        LabelParishName->setGeometry(QRect(30, 80, 581, 131));
        ...
        comboBoxParish->setGeometry(QRect(360, 20, 271, 24));
